...
| oneFilePerRequest:boolean       | If you want to send your files as one per network request not all in one request (and under one formdata) then set it as 'true'. | false|
